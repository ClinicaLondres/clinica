  ...
  const data = [
    {
      ...
      doctores: [
        ...
        { nombre: "Dra. Laura Gómez", tratamiento: "Prevención y diagnóstico temprano", img: "/image/medico2.jpg" },
      ],
    },
    {
      categoria: "Dermatología",
      doctores: [
        { nombre: "Dra. Ana Torres", tratamiento: "Tratamiento del acné y cuidado de la piel", img: "/image/medico3.jpg" },
        { nombre: "Dr. Carlos Díaz", tratamiento: "Dermatología estética y láser", img: "/image/medico4.jpg" },
      ],
    },
    {
